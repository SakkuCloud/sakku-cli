export const messages = {
  ...
  enter_tag_for_start: 'Enter version of application you want to start from',
  ...
  commit_oldest_contailer: '(If you ignore this field, the oldest one will be commited)',
  ...
  zone_is_set_to_datacenter: 'Server is set to ',
